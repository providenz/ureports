...
def get_file_path(instance, filename):
    return os.path.join("downloaded_files", instance.project.name, instance.category.name, filename)
...
class TableDownload(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.SET_NULL, null=True, related_name="project_name")
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name="category_name")
...
class DataTable(models.Model):
    project = models.ForeignKey(Project, on_delete=models.SET_NULL, null=True, related_name="data_entries")
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name="data_entries")
    ...
    def save(self, *args, **kwargs):
        if self.demography and self.place:
            ...
            try:
                ...
                region = RegionStatistic.objects.create(name=name, oblast=oblast, benef=benef, project=self.project)
                region.activities.add(self.category)
                region.save()
